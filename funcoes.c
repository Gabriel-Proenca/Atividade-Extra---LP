...
void lerDados(Pessoa pessoas[], int *n) {
    for (int i = 0; i < *n; i++) {
        ...
        while (pessoas[i].idade <= 0) {
            printf("Idade invalida. Digite uma nova idade: ");
            scanf("%d", &pessoas[i].idade);
        }

        // Ler gênero
        printf("Escolha seu genero (1 - masculino, 2 - feminino): ");
        scanf("%d", &pessoas[i].genero);
        while (pessoas[i].genero != 1 && pessoas[i].genero != 2) {
            printf("Genero invalido. Escolha entre 1 para masculino e 2 para feminino: ");
            scanf("%d", &pessoas[i].genero);
        }
        ...
        while (pessoas[i].peso <= 0) {
            printf("Peso invalido. Digite um peso valido: ");
            scanf("%f", &pessoas[i].peso);
        }
    }
}
